...
const Confirmation = (props) => {
    ...
    useEffect(() => {
        var thehotel = hotelsr.filter(el => el.id == props.match.params.id)[0]
        setHotel(thehotel)
    }, [])
    const submit = () => {
        alert(`thanks for booking ${hotel.name} `)
    }
    ...
    return (
        <div>
            ...
            <div className='confirmationbox'>
                ...
                <div className="form-style-2 box">
                    ...
                    <form>
                        <label htmlFor="field1">
                            ...
                            <input type="text" className="input-field" name="field1" />
                        </label>
                        <label htmlFor="field1">
                            <span>
                        ...
                        <label for="field5"><span>Special Requests <span class="required">*</span></span><textarea name="field5" class="textarea-field"></textarea></label>

                        <label>
                            <span> </span>
                            <button onClick={submit} className="ba">submit</button>
                        </label>
                    </form>
                </div>
            </div>
